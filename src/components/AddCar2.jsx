...
function AddCar(car) {
    ...
    // const see_form = () => {
    //     form.current.style.diplay = ''
    // }
    
    return(
        <>
            {/* <div className="boton-agregar d-flex justify-content-center">
            <button onClick={() => {
                form.current.style.diplay = ''
            }} id='btnAdd' type="button" className="btnAdd">
                Añadir Vehiculo
            </button>
            </div> */}
            <div ref={form} id="staticBackdrop" tabIndex="-1">
